...
Font.register({
  family: 'Grandstander',
  src: 'https://tvimmduaznytpjpbwfiw.supabase.co/storage/v1/object/public/assets/fonts/Grandstander-Bold.ttf',
})

Font.register({
  family: 'Atkinson',
  fonts: [
    { src: 'https://tvimmduaznytpjpbwfiw.supabase.co/storage/v1/object/public/assets/fonts/Atkinson-Regular.ttf' },
    { src: 'https://tvimmduaznytpjpbwfiw.supabase.co/storage/v1/object/public/assets/fonts/Atkinson-Bold.ttf', fontWeight: 700 },
  ]
})
